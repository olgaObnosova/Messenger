...
app.post('/upload', upload.single('file'), (req, res) => {
    ...
    if (fileType === 'image') {
        ...
        msgData.message = `🎵 Голосовое сообщение`;
    } else {
...
// Обработка голосовых сообщений (base64)
app.post('/upload-audio', express.json({ limit: '10mb' }), (req, res) => {
    const { username, audioData, duration } = req.body;
